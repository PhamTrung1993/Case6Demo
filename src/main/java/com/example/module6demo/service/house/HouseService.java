...
import com.example.module6demo.repository.IHouseRepository;
...
public class HouseService implements IHouseService {
    ...
    @Override
    public Iterable<House> findHouseByAll(String bedrooms, String bathrooms, String address, long rentMin, long rentMax, String endTime, String startTime) {
